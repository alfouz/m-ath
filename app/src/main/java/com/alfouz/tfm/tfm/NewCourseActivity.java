    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.course_menu_save) {
            ...
            if(!title.getText().toString().equals("")) {
                ...
                }, this).execute(Long.toString(MyApplication.getIdUser()), title.getText().toString(), description.getText().toString(), Float.toString(ratingBar.getRating()), switchPublic.isActivated() ? "t" : "f", Integer.toString(((CourseType)spinner.getSelectedItem()).getId()), "-1",Long.toString(MyApplication.getIdUser()));
            }else{
